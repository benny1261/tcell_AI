'''Source:https://github.com/purbayankar/HybridSN-pytorch'''
...
parser.add_argument(
    '-e', '--epoch', type=int, dest='epoch', default=10, help="No. of epoch")
parser.add_argument(
...
def load_dataset(Dataset, split=0.9):
    ...
    if Dataset == 'T':
        t = sio.loadmat(data_path + 'data_x.mat')
        gt_t = sio.loadmat(data_path + 'data_y.mat')
        data_hsi = t['data_x']
        gt_hsi = gt_t['data_y']
        K = data_hsi.shape[2]
        TOTAL_SIZE = 100000
